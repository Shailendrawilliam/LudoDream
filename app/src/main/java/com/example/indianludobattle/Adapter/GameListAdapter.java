...
import com.example.indianludobattle.Fragment.PlayerFragment;
...
public class GameListAdapter extends FragmentPagerAdapter {
    private Context context;
    private int noOfTabs;
    private List<MainModel> mainModelList;
    public GameListAdapter(@NonNull FragmentManager fm, Context context, int noOfTabs, List<MainModel> mainModelList) {
        super(fm);
    ...
    public PlayerFragment getItem(int position) {
        ...
        return  PlayerFragment.newInstance(mainModel.getTab_name());
    }
